...
7. Visit blkpvnthr.com in your browser to access the dashboard and markets screener UI. The frontend will automatically load the latest session state file generated by `monitor.py`.
